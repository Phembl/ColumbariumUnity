...
public class FirstPersonController : MonoBehaviour
{
    ...
    private bool isSomethingHovered = false;
    ...
    private void CheckForInteractableObjects()
    {
        ...
        RaycastHit hit;
        if (Physics.Raycast(playerCamera.transform.position, playerCamera.transform.forward, out hit, interactionRange, interactionLayer))
        {
